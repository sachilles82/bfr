                                    ...
                                    <div class="relative mt-2">
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div x-ref="dropdown"
                                                     class="relative z-30 p-2 overflow-y-auto max-h-60">
        ...
        return {
            ...
            initializeDefaultCountry() {
                if (this.selectedCountryId) {
                    const defaultCountry = this.countries.find(country => country.id === this.selectedCountryId);
                    if (defaultCountry) {
                ...
                if (this.selectedStateId) {
                    const defaultState = this.states.find(state => state.id === this.selectedStateId);
                    if (defaultState) {
                        this.selectedState = defaultState;
                        this.selectedStateName = defaultState.name;
                    }
                }

                if (this.selectedCityId) {
                    const defaultCity = this.cities.find(city => city.id === this.selectedCityId);
                    if (defaultCity) {
                        this.selectedCity = defaultCity;
                        this.selectedCityName = defaultCity.zip_city;
                    }
                }
            },
