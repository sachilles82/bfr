<div x-data="dropdownHandler()">
    <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div class="sm:col-span-4 flex">
            <<div x-data="dropdownHandler()" @alpine:init="init">
                <div class="mt-4">
                    ...
                    <div class="relative mt-2">
                        <div
                            ...
                            <div class="mt-1 min-w-[200px] dark:bg-gray-800 shadow-md dark:border dark:border-gray-700 bg-white rounded-b-md absolute top-full left-0 z-30"
                                ...
                                <div x-ref="dropdown" class="relative z-30 p-2 overflow-y-auto max-h-60">
                                    ...
                                    <span
                                        ...
                                        <svg :class="{'w-4 h-4': selectedCountryId === country.id}"
