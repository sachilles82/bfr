        ...
        <li>
            <a href="{{ route('settings.company') }}" wire:navigate.hover
               class="{{ request()->routeIs('settings.company') ? 'text-indigo-600 bg-gray-50 dark:text-white dark:bg-gray-800' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white' }} group flex gap-x-3 rounded-md py-2 pl-2 pr-3 text-sm leading-6 font-semibold">
                <flux:icon.building-office class="h-6 w-6 {{ request()->routeIs('settings.company') ? 'dark:text-white dark:bg-gray-800' : 'hover:bg-gray-50 group-hover:text-indigo-600 dark:hover:bg-gray-800 text-gray-400 dark:text-gray-500 dark:group-hover:text-white' }}"/>
        ...
        <li>
            <a href="{{ route('settings.roles') }}" wire:navigate.hover
               class="{{ request()->routeIs('settings.roles') ? 'text-indigo-600 bg-gray-50 dark:text-white dark:bg-gray-800' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white' }} group flex gap-x-3 rounded-md py-2 pl-2 pr-3 text-sm leading-6 font-semibold">
                <flux:icon.shield-check class="h-6 w-6 {{ request()->routeIs('settings.roles') ? 'dark:text-white dark:bg-gray-800' : 'hover:bg-gray-50 group-hover:text-indigo-600 dark:hover:bg-gray-800 text-gray-400 dark:text-gray-500 dark:group-hover:text-white' }}"/>
        ...
        <li>
            <a href="{{ route('settings.departments') }}" wire:navigate.hover
               class="{{ request()->routeIs('settings.departments', 'settings.departments.show') ? 'text-indigo-600 bg-gray-50 dark:text-white dark:bg-gray-800' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white' }} group flex gap-x-3 rounded-md py-2 pl-2 pr-3 text-sm leading-6 font-semibold">
                <flux:icon.shield-check class="h-6 w-6 {{ request()->routeIs('settings.departments', 'settings.departments.show') ? 'dark:text-white dark:bg-gray-800' : 'hover:bg-gray-50 group-hover:text-indigo-600 dark:hover:bg-gray-800 text-gray-400 dark:text-gray-500 dark:group-hover:text-white' }}"/>
