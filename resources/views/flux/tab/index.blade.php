...
if ($variant === 'pills') {
    ...
    $classes = Flux::classes()
        ->add('group flex whitespace-nowrap flex-1 justify-center items-center gap-2')
    ...
    $iconClasses = Flux::classes('!size-5 text-zinc-500 dark:text-zinc-400 group-data-[selected]:text-zinc-800 group-data-[selected]:dark:text-white');
    $iconVariant ??= 'outline';
} else {
    $classes = Flux::classes()
