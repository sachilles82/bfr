...
$classes = Flux::classes()
    ...
    ->add('text-sm font-medium text-gray-600 hover:text-gray-800 dark:hover:text-white dark:text-gray-400 data-[checked]:text-gray-800 data-[checked]:dark:text-white')
...
$iconClasses = Flux::classes('text-gray-500 dark:text-gray-400 [ui-radio[data-checked]_&]:text-gray-800 dark:[ui-radio[data-checked]_&]:text-white');
$iconVariant ??= 'mini';
@endphp
