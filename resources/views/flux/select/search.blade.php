...
<div class="relative flex grow mx-[-5px] mt-[-5px] mb-[5px]" data-flux-select-search>
    <div class="absolute top-0 bottom-0 flex items-center justify-center text-xs text-gray-400 pl-3.5 left-0">
    ...
    <?php if ($loading): ?>
    <div
        class="opacity-0 [[data-flux-select-search]:has([data-flux-loading])_&]:opacity-100 transition-opacity absolute top-0 bottom-0 flex items-center justify-center pr-2.5 right-0">
        <flux:icon.loading class="text-gray-400 [[data-flux-menu-item]:hover_&]:text-current" variant="mini"/>
    </div>
    <?php endif; ?>

    <?php if ($closable): ?>
    <div
        class="[[data-flux-select-search]:has([data-flux-loading])_&]:opacity-0 transition-opacity absolute top-0 bottom-0 flex items-center justify-center pr-1 right-0">
        <ui-close>
    ...
    <div
        class="[[data-flux-select-search]:has([data-flux-loading])_&]:opacity-0 transition-opacity absolute top-0 bottom-0 flex items-center justify-center pr-1 right-0 [[data-flux-select-search]:has(input:placeholder-shown)_&]:hidden">
