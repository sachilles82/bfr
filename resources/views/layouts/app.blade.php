                        ...
                        <li>
                            <ul role="list" class="-mx-2 space-y-1">
                                <li>
                                    ...
                                    <a href="#" class="group flex gap-x-3 rounded-md bg-gray-50 p-2 text-sm font-semibold leading-6 text-indigo-600 dark:bg-gray-900 dark:text-white dark:hover:text-white dark:hover:bg-gray-800">
                                        <svg class="h-6 w-6 shrink-0 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                                        </svg>
                                        Dashboard
                                    </a>
{{--                                    <a href="{{ route('app.dashboard') }}" wire:navigate.hover class="dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-800  group flex w-full flex-col items-center rounded-md p-3 text-xs font-medium">--}}
...
{{--                                    </a>--}}
{{--                                    <a href="{{ route('employees.page') }}" wire:navigate.hover--}}
{{--                                       class="{{ request()->routeIs(['employees.page', 'employee.profile', 'employee.overview','employee.report', 'employee.salary','employee.activity','employee.document','employee.holiday','employee.dialog','employee.appreciation','employee.remark','employee.permission.auth', 'employee.permission.report','employee.setting']) ? 'text-white bg-indigo-800 dark:text-white dark:bg-gray-800' : 'dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-800 text-indigo-100 hover:bg-indigo-800 hover:text-white' }} group flex w-full flex-col items-center rounded-md p-3 text-xs font-medium">--}}
{{--                                        <svg class="{{ request()->routeIs(['employees.page', 'employee.profile', 'employee.overview', 'employee.report','employee.salary','employee.activity','employee.document','employee.holiday','employee.dialog','employee.appreciation','employee.remark','employee.permission.auth', 'employee.permission.report','employee.setting']) ? 'dark:text-white dark:bg-gray-800' : 'text-indigo-300 dark:text-gray-400 group-hover:text-white' }} h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">--}}
{{--                                            <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />--}}
{{--                                        </svg>--}}
{{--                                        <span class="mt-2">{{ __('Employees')}}</span>--}}
{{--                                    </a>--}}
                                </li>
                                <li>
...
<div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
    <!-- Sidebar component, swap this element with another sidebar if you like -->
    <div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-gray-50 dark:bg-gray-900 px-6 pb-4">
        <div class="flex h-16 shrink-0 items-center">
            <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="Your Company">
        </div>
        ...
        <nav class="flex flex-1 flex-col">
            <ul role="list" class="flex flex-1 flex-col gap-y-7">
                ...
                <flux:navlist variant="ghost">
                    <flux:navlist.item wire:navigate.hover icon="home"  href="/{{ route('dashboard') }}" current>Dashboard</flux:navlist.item>
                    <flux:navlist.item class="!text-green-700" icon="inbox" badge="12" href="#">Inbox</flux:navlist.item>
...
{{--        </main>--}}
    ...
    <aside class="fixed inset-y-0 right-0 hidden w-96 overflow-y-auto bg-gray-50 border-l border-gray-200 px-4 py-6 sm:px-6 lg:px-8 xl:block">
